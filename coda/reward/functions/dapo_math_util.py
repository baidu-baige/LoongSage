"""from https://github.com/verl-project/verl/blob/release/v0.7.1/verl/utils/reward_score/math_dapo.py"""
...
def verify(
    ...
    Returns:
        ``(correct, pred)`` — whether the solution is correct, and the extracted
        prediction.
    """
...
def compute_score(
    ...
    Returns:
        ``{"score": 1.0 if correct else -1.0, "acc": correct, "pred": prediction}``
    """
